        ...
        <div className='relative max-w-6xl mx-auto'>
          ...
          <div className='text-center mt-10 sm:mt-12'>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center gap-4 mt-10'>
              <button onClick={()=>navigate("/builder")} className='w-full sm:w-auto px-8 py-4 rounded-2xl bg-linear-to-r from-pink-600 to-orange-500 text-white font-semibold text-sm sm:text-base shadow-[0_12px_40px_rgba(168,85,247,0.25)] hover:scale-[1.02] transition-all cursor-pointer'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6'>
            {STEPS.map((s,i)=>(
              <div key={i} className='group bg-[#f8fafc] hover:bg-white border border-gray-100 rounded-[28px] p-7 transition-all hover:shadow-[0_15px_50px_rgba(0,0,0,0.06)]'>
                <span className='text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-pink-600 to-orange-500'>{s.step}</span>
        ...
        <div className='max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left'>
          <div>
            <div onClick={()=>navigate("/")} className='flex items-center gap-2.5'>
                    ...
                    <h1 className='font-bold text-xl text-gray-100 leading-none'>Assisto.<span className='text-transparent bg-clip-text bg-linear-to-r from-pink-600 to-orange-500'>AI</span></h1>
          ...
          <p className='text-gray-500 text-sm'>
            © {new Date().getFullYear()} AssistoAI. All rights reserved.
          </p>
