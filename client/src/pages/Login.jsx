                ...
                <div className='grid lg:grid-cols-2 gap-16 items-center'>
                    ...
                    <div>
                        ...
                        <h1 className='mt-8 text-5xl lg:text-7xl font-black leading-tight text-[#081028]'>
                            Build AI Assistants
                            <span className='block text-transparent bg-clip-text bg-linear-to-r from-pink-600 to-orange-500'>For Any Website</span>
                        </h1>
                        ...
                        <button onClick={handleLogin} className='mt-10 h-16 px-8 rounded-2xl bg-linear-to-r from-pink-600 to-orange-500 text-white text-lg font-semibold flex items-center gap-4 shadow-[0_20px_80px_rgba(139,92,246,0.25)] hover:scale-[1.02] transition cursor-pointer'>
                    ...
                    <div className='relative'>
                        ...
                        <div className='relative rounded-[40px] border border-black/5 bg-white shadow-[0_20px_80px_rgba(0,0,0,0.06)] p-8 overflow-hidden'>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <div className='w-16 h-16 rounded-3xl bg-linear-to-r from-pink-600 to-orange-500 flex items-center justify-center shadow-[0_10px_40px_rgba(139,92,246,0.25)] p-3'>
...

                                {
                                    FEATURES.map(({icon , title , desc}, index) => (
                                        <div key={index} className='flex gap-5 rounded-3xl border border-black/5 bg-[#f8fafc] p-5'>
                                            ...
                                            <div className='min-w-15 h-15 rounded-2xl bg-linear-to-r from-pink-600 to-orange-500 text-white text-2xl flex items-center justify-center shadow-[0_10px_30px_rgba(139,92,246,0.20)]'>
                                               {icon}
                                            </div>
                                            <div>
