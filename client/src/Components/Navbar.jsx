    ...
    <div className='sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-orange-100'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between'>
        ...
        <div onClick={()=>navigate("/")} className='flex items-center gap-2.5'>
          ...
          <h1 className='font-bold text-xl text-gray-700 leading-none'>Assisto.<span className='text-transparent bg-clip-text bg-linear-to-r from-pink-600 to-orange-500'>AI</span></h1>
        ...
        {user && (<div className='hidden md:flex items-center gap-3'>
          ...
          <button onClick={()=>navigate("/builder")} className='px-4 py-2 rounded-xl bg-linear-to-r from-pink-600 to-orange-500 text-white text-sm font-medium shadow-md hover:scale-[1.02] transition-all cursor-pointer'>Builder</button>
          ...
          <div className='flex items-center gap-3 px-4 py-2 rounded-2xl bg-white border border-orange-100 shadow-sm'>
            ...
            <div className='w-8 h-8 rounded-full bg-linear-to-r from-pink-600 to-orange-500 flex items-center justify-center shrink-0'>
        ...
        <div className='md:hidden px-4 pb-4'>
          ...
          <div className='bg-white rounded-2xl border border-orange-100 shadow-lg p-4'>
            ...
            <div className='flex flex-col gap-3 mt-4'>
              <button className='w-full py-2.5 rounded-xl bg-linear-to-r from-pink-600 to-orange-500 text-white text-sm font-medium' onClick={()=>{navigate("/builder");setMenuOpen(false)}}>Bulider</button>
