...
const themes = {
  ...
  sunset: {
    bg:
      "bg-[rgba(13,13,13,0.989)] backdrop-blur-[45px]",

    overlay:
      "bg-[radial-gradient(circle_at_top,rgba(11,11,11,0.05),transparent_45%)]",

    orb:
      "from-[#fb02b0] to-[#ff6600]",
    ...
    button:
      "from-[#ff6600] to-[#fb02b0]",

    micGlow:
      "shadow-[0_0_35px_rgba(34,211,238,0.34),0_0_95px_rgba(139,92,246,0.28),0_0_150px_rgba(56,189,248,0.18)]",
  },
      ...
      <div className={`relative w-70 h-112.5 sm:w-82.5 sm:h-125 md:w-95 md:h-137.5 rounded-4xl sm:rounded-[42px] overflow-hidden transition-all duration-500 ${current.bg} ${current.cardBorder} shadow-[0_20px_80px_rgba(0,0,0,0.28)]`}>
        ...
        <div className='absolute top-4 right-4 sm:top-5 sm:right-5 z-30 flex items-center gap-2'>
          ...
          <button
            ...
            className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white border transition-all cursor-pointer ${theme === "light"
          ...
          <button
            ...
            className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-linear-to-br bg-orange-500 border transition-all cursor-pointer ${theme === "sunset"
          ...
          <button
            ...
            className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-linear-to-r from-emerald-400 to-green-500 border transition-all cursor-pointer ${theme === "neon"
